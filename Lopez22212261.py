...
kP, kI, kD = 215.701641683928, 3843.6789548869,0.590584382218798
Cr = 1E-6
Re = 1/(kI*Cr)
Rr = kP*Re
Ce = kD/Rr
...
print(f"La funcion de trnasferencia del controlador PID es {PID}")
...
plt.legend(bbox_to_anchor = (0.5, -0.2), loc = 'center', ncol=3,fontsize = 9, frameon= True)
plt.show()
fg2.savefig('ramp_python.pdf',bbox_inches = 'tight')
